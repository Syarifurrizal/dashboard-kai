...
import BalanceMovementChartBar from "@/components/balancemovement/BalanceMovementChartBar";
    ...
    return (
        <>
            <main className="w-full flex flex-col gap-4">
                <h1 className="font-bold text-2xl">Balance Movement Gabungan</h1>
                {loading ? (
                    ...
                    <div className="flex flex-col w-full gap-4">
                        <BalanceMovementChartBar data={data} />
